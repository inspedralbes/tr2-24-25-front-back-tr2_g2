      ...
      :class="[
        ...
        <div class="flex flex-wrap justify-between mb-4">
          ...
          <div class="w-full sm:w-1/3 mt-1">
            ...
            <p class="text-gray-700 dark:text-gray-400 text-sm mt-1">{{ report.created_at }}</p>
          </div>
        </div>
        <div class="mb-6">
          <p class="text-base font-semibold text-gray-900 dark:text-gray-300">Usuari que Reporta:</p>
          <p class="text-gray-700 dark:text-gray-300 text-sm">{{ report.reporting_user_name }}</p>
          <p class="text-xs text-gray-500 dark:text-gray-400">{{ report.reporting_user_email }}</p>
        </div>
        <div class="mb-6">
          <p class="text-base font-semibold text-gray-900 dark:text-gray-300">Usuari de la Publicació:</p>
          <p class="text-gray-700 dark:text-gray-300 text-sm">{{ report.publication_user_name }}</p>
          <p class="text-xs text-gray-500 dark:text-gray-400">{{ report.publication_user_email }}</p>
        </div>
        <div class="mb-6">
