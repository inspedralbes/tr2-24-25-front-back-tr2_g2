<template>
    <section class="relative pt-40 pb-24">
        <img src="https://pbs.twimg.com/profile_banners/889046489942675456/1705870682/1500x500" alt="cover-image" class="w-full absolute top-0 left-0 z-0 h-60 object-cover sm:w-1/2 md:w-1/3  lg:w-1/4 h-45">
        <div class="w-full max-w-7xl mx-auto px-6 md:px-8">
            <div class="flex items-center justify-center sm:justify-start relative z-10 mb-5">
                <img src="https://pbs.twimg.com/profile_images/1646143747200000004/662M_9h1_400x400.jpg" alt="user-avatar-image" class="border-4 border-solid border-white rounded-full object-cover w-40 h-40">
            </div>
