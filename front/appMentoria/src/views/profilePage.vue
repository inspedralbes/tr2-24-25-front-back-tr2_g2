<template>
  ...
  <section
    class="relative pt-40 pb-24 min-h-screen flex flex-col justify-between"
  >
    <img
      :src="`${user.banner}`"
      alt="cover-image"
    ...
    <div
      class="absolute right-4 md:right-5 top-60 transform -translate-y-8 md:-translate-y-8"
    >
      <button
    ...
    <div class="w-full max-w-7xl mx-auto px-6 md:px-8 flex-grow">
      ...
      >
        ...
        >
          <ul
            class="flex items-center max-sm:justify-center max-sm:flex-wrap gap-2.5"
          >
            <li
    ...
    >
      <!-- Botón de Discord -->
      <a
        href="https://discord.com/invite/tu-invite"
        target="_blank"
      ...
      <a
        @click="chatButton(userid1, userid2, router)"
        href="#"
        rel="noopener noreferrer"
        class="flex items-center py-3 px-6 bg-gray-800 text-white rounded-full shadow-lg shadow-black/30 transition-all duration-500 hover:shadow-gray-100 hover:bg-gray-900"
      >
